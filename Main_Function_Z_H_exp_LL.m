...
for k = 2:10000
    ...
    Yk_1 = e(:,k-1)'*Q*e(:,k-1)+u(:,k-1)'*R*u(:,k-1)- gamma2*w(:,k-1)'*w(:,k-1)+ 0*Z(:,k)'*Q*Z(:,k);
...
%%
    ...
    for LL=1:L
        ...
        if 3000 <= k && k < 6000
            ...
            temp_1 =temp_1-aj*(delta_xK*EJK)/(delta_xK'*delta_xK+1)-PE_C*aj*M1*P1-.0001*aj*Fisher1*(temp_1-W_critic(:,:,2999))*EWC;
        elseif 6000<=k
            temp_1 =temp_1-aj*(delta_xK*EJK)/(delta_xK'*delta_xK+1)-PE_C*aj*M1*P1-.0001*aj*Fisher2*(temp_1-W_critic(:,:,5999))*EWC;
        else
